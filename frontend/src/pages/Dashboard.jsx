                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                      ...
                      {selectedApp.payment_status !== 'paid' && (
                        <button
                          onClick={() => { setPaymentAppId(selectedApp.id); setShowPayModal(true); }}
                          className="bg-green-600 hover:bg-green-500 text-white font-bold py-2 px-6 rounded-xl flex items-center gap-2"
                        >
              ...
              {showPayModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
                  <div className="glass-card max-w-md w-full p-6 space-y-6 relative border border-white/15 animate-slide-up">
                    ...
                    <h4 className="text-xl font-bold text-white">Initiate Secure Fee Payment</h4>
                    ...
                    <form onSubmit={handleMakePayment} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-300">Select Fee Amount</label>
                        <select
                          value={paymentAmount}
                          onChange={(e) => setPaymentAmount(e.target.value)}
                          className="input-field cursor-pointer"
                        >
                          <option value="5000" className="bg-slate-900">₹ 5,000 (Trademark Filing Fee)</option>
                          <option value="15000" className="bg-slate-900">₹ 15,000 (Patent Filing Fee)</option>
                          <option value="3000" className="bg-slate-900">₹ 3,000 (Copyright Filing Fee)</option>
                        </select>
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-300">Payment Gateway</label>
                        <select
                          value={paymentMethod}
                          onChange={(e) => setPaymentMethod(e.target.value)}
                          className="input-field cursor-pointer"
                        >
                          <option value="credit_card" className="bg-slate-900">Credit / Debit Card</option>
                          <option value="upi" className="bg-slate-900">UPI / GPay</option>
